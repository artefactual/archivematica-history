...
public class FileUtility extends ToolBase {
	...
	private List<String> WIN_COMMAND = new ArrayList(Arrays.asList(Fits.FITS_TOOLS+"file_utility_windows/bin/file.exe"));
	private List<String> UNIX_COMMAND = new ArrayList(Arrays.asList("file"));
	private List<String> FILE_TEST_COMMAND = new ArrayList(Arrays.asList("which", "file"));
	...
	public final static String regex_map_path = Fits.FITS_XML+"fileutility/regex_map.xml";
	...
	public ToolOutput extractInfo(File file) throws FitsToolException {
		...
		if(execMimeOut.startsWith("text/plain") && execMimeOut.contains("charset=")) {
			mime = "text/plain";
