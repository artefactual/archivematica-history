    ...
    <fits xmlns="http://hul.harvard.edu/ois/xml/ns/fits/fits_output"
		...
		<!-- 
		 ...
		 -->
			...
			<grayResponseCurve>
				<xsl:value-of select="exiftool/GrayResponseCurve"/>
			</grayResponseCurve>
			<grayResponseUnit>
			...
			<!--  make and model are ambiguous so only use them if source is specified -->
			<xsl:choose>
			...
			<focalLength>
				<xsl:value-of select="exiftool/FocalLength"/>
			</focalLength>
			<flashEnergy>
			...
			<gpsDateStamp>
				<xsl:value-of select="exiftool/GPSDateStamp"/>
			</gpsDateStamp>
			<gpsDifferential>
