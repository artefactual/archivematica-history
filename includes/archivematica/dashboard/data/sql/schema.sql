CREATE TABLE aip (id BIGINT AUTO_INCREMENT, aip_status_id BIGINT NOT NULL, identifier VARCHAR(255), dateaccepted DATETIME NOT NULL, checksum VARCHAR(255), checksum_type VARCHAR(255), location VARCHAR(255), dip_location VARCHAR(255), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE sip (id BIGINT AUTO_INCREMENT, identifier VARCHAR(255), title VARCHAR(255) NOT NULL, datereceived DATETIME NOT NULL, provenance VARCHAR(255), partof VARCHAR(255), checksum VARCHAR(255), checksum_type VARCHAR(255), PRIMARY KEY(id)) ENGINE = INNODB;
