CREATE TABLE aip (id BIGINT AUTO_INCREMENT, identifier VARCHAR(255), dateaccepted DATETIME NOT NULL, checksum VARCHAR(255), checksum_type VARCHAR(255), location VARCHAR(255), dip_location VARCHAR(255), PRIMARY KEY(id)) ENGINE = INNODB;
