...
<?php endif; ?>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['sip_status_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['sip_status_id']->renderError() ?>
          <?php echo $form['sip_status_id'] ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <th><?php echo $form['dateSubmitted']->renderLabel() ?></th>
        <td>
          <?php echo $form['dateSubmitted']->renderError() ?>
          <?php echo $form['dateSubmitted'] ?>
        </td>
      </tr>
      <tr>
