...
sudo ln "${svnDir}src/MCPServer/init.d/archivematica-mcp-serverd" "/etc/init.d/"
sudo ln "${svnDir}src/MCPClient/init.d/archivematica-mcp-clientd" "/etc/init.d/"
sudo ln "${svnDir}src/transcoder/init.d/openofficed" "/etc/init.d/"
